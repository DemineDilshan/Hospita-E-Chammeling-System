...
public class ActiveShedulePDFExporter {
	
	private List<Schedule> listSchedule;
	
	public ActiveShedulePDFExporter(List<Schedule> listSchedule) {
	...
	public void export(HttpServletResponse response) throws DocumentException, IOException{
		...
		Paragraph title = new Paragraph("List of Active Schedule",font);
